...
const OPENINGS := {
	...
	"redoubts": {
		"blue": [
			["A5", 0, 0, "H"], ["A4", 0, 1, "H"], ["A3", 0, 2, "H"],
			["A2", 0, 3, "H"], ["A1", 0, 4, "H"], ["A6", 1, 4, "H"],
			["A7", 16, 4, "H"], ["A8", 17, 4, "H"], ["A9", 17, 3, "H"],
			["A10", 17, 2, "H"], ["A11", 17, 1, "H"], ["A12", 17, 0, "H"],
			["B4", 1, 0, "V"], ["B3", 1, 2, "V"], ["B5", 2, 3, "V"],
			["B2", 16, 0, "V"], ["B1", 16, 2, "V"], ["B6", 15, 3, "V"],
			["C2", 2, 1, "H"], ["C3", 5, 3, "H"], ["C1", 13, 3, "H"],
			["Objective", 9, 0, "H"], ["General", 9, 4, "H"],
		],
		"red": [
			["A1", 0, 11, "H"], ["A2", 0, 12, "H"], ["A3", 0, 13, "H"],
			["A4", 0, 14, "H"], ["A5", 0, 15, "H"], ["A6", 1, 11, "H"],
			["A7", 16, 11, "H"], ["A8", 17, 11, "H"], ["A9", 17, 12, "H"],
			["A10", 17, 13, "H"], ["A11", 17, 14, "H"], ["A12", 17, 15, "H"],
			["B3", 1, 12, "V"], ["B4", 1, 14, "V"], ["B5", 2, 11, "V"],
			["B1", 16, 12, "V"], ["B2", 16, 14, "V"], ["B6", 15, 11, "V"],
			["C2", 2, 13, "H"], ["C3", 5, 11, "H"], ["C1", 13, 11, "H"],
			["General", 9, 11, "H"], ["Objective", 9, 15, "H"],
		],
	},
}
